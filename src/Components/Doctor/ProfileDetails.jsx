      ...
      <div className="flex-1 bg-white rounded-lg shadow-xl p-8">
        ...
        <ul className="mt-2 text-gray-700">
          <li className="flex border-y py-2">
            ...
            <span className="text-gray-700">{doctor?.user?.username}</span>
          </li>
          ...
          <li className="flex border-b py-2">
            ...
            <span className="text-gray-700">{doctor?.user?.phone_number}</span>
          </li>
          <li className="flex border-b py-2">
          ...
          <li className="flex border-b py-2">
            ...
            <span className="text-gray-700">{doctor?.user?.date_joined}</span>
          </li>
