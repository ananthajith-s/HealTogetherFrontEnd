...
function BannerFirst() {
  ...
  return (
  <div className="bg-cover bg-center h-4/4vh flex mt-3 mx-9 rounded-md" style={{backgroundImage: `url(${home})`}}>
    <div className="flex flex-1" >
    <div className="p-20 lg:p-44">
            <h1 className=" text-4xl font-serif font-bold text-start color=black">
